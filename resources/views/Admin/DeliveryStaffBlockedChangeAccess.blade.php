...
<div class="col-12 col-lg-9 border border-dark rounded p-3">
    <div class="container">
        <div class="row justify-content-center">
            <h3><i class="fas fa-user-edit"></i>&nbsp &nbsp Blocked Delivery Staffs Access Change</h3>
        </div>
        <hr class="mb-4">
        ...
        <table class="table table-bordered table-hover">
            ...
            <tbody>
                <tr>
                    ...
                    <td><img src="{{asset($DeliveryStaff->user_info->image)}}" alt="None width="200" height="200"> </td>
                </tr> 
            </tbody>
        </table>
        <br>
