...
<div class="col-12 col-lg-9 border border-dark rounded p-3">
    <div class="container">
        <div class="row justify-content-center">
            <h3><i class="fas fa-male"></i>&nbsp &nbsp All Blocked Delivery Staffs</h3>
        </div>
        <hr class="mb-4">
        <form method="POST">
            {{@csrf_field()}}
                ...
                @if(count($DeliveryStaffs)>0)
                    @foreach($DeliveryStaffs as $c)
                        <tr>
                            ...
                            <td>
                                <a href="{{route('admin.DeliveryStaff.blocked.changeAcssess',['id'=> encrypt($c->id)])}}" class="btn btn-warning mb-2">Change Access</a>
                            </td>
                        </tr>
                    @endforeach
                @endif    
